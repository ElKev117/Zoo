...
public class WildAnimal extends Animal {
    ...
    public WildAnimal(String name, String code, int age, String gender, int dangerLevel){
        super(name, code, age, gender);
        this.dangerLevel = dangerLevel;
    }
    
    public WildAnimal(String name, String code, int age, String gender, String state, String origin, boolean mammal, int dangerLevel, String habitat){
